		...
		<block v-if="type == 'tag_str'">
			...
			<view class="f-wrap">
				...
				<view class="tag-add" @click="showAddTag = true">
					<u-icon color="#999" size="25" name="plus"></u-icon>
				</view>
				<!-- 添加弹窗 -->
				<u-popup :show="showAddTag" mode="center" width="80%">
			...
			<view class="f-wrap">
				...
				<view @click="onTagAdd(item)" v-for="(item, index) in tagList" :key="index" class="tag">{{ item }}
				</view>
			</view>
		</block>
