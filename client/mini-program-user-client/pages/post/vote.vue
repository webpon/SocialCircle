<template>
	<view>
		<!-- 投票弹窗 -->
		<u-popup :show="showVotePopup" height="100%" mode="bottom">
		...
		<view class="container">
			<textarea placeholder="这一刻的想法..." :auto-height="true" maxlength="-1" v-model="content" class="post-txt"></textarea>
			...
			<view @click="chooseLocation" class="choose-item">
				<u-icon class="add-icon" name="map" color="#999" :size="20"></u-icon>
