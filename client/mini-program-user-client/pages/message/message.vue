<template>
	<view>
		<u-grid :col="3" :border="false" @click="toNav">
			<u-grid-item name="1">
				<u-badge :value="msgNum.thumb_collect" max="99" :absolute="true" :offset="[0, 30]"></u-badge>
				<image class="nav-icon" src="/static/images/icon/souc.png"></image>
				<view class="grid-text">赞和收藏</view>
			</u-grid-item>
			<u-grid-item name="2">
				<u-badge :value="msgNum.follow" max="99" :absolute="true" :offset="[0, 30]"></u-badge>
				<image class="nav-icon" src="/static/images/icon/gz.png"></image>
				<view class="grid-text">新增关注</view>
			</u-grid-item>
			<u-grid-item name="3">
				<u-badge :value="msgNum.comment" max="99" :absolute="true" :offset="[0, 30]"></u-badge>
